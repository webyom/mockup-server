...
var config = {
  init: function() {
    argv = yargs
          .usage('Usage: $0 --port [number] --base [string] --context [string] --fallback [string] --query [string] --enable-query --ignore-queries v token')
          ...
          .alias('t', 'content-type').default('t', 'application/json; charset=utf-8').describe('t', 'content-type of response header')
